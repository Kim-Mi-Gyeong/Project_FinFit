...
<table style="margin:0 auto; width:85%;">
  <tr>
    <td align="center" valign="top" style="padding:5px;">
      <img src="image.png" width="80" style="border-radius:50%; height:auto;"><br><br>
      <strong>이한세 (Michael)</strong><br>
      <em># Squat Analysis</em>
    </td>
    <td align="center" valign="top" style="padding:5px;">
      <img src="image1.png" width="80" style="border-radius:50%; height:auto;"><br><br>
      <strong>김미경 (Mia)</strong><br>
      <em># Body Analysis & Exercise Tips</em>
    </td>
    <td align="center" valign="top" style="padding:5px;">
      <img src="image3.png" width="80" style="border-radius:50%; height:auto;"><br><br>
      <strong>이준혁 (Simon)</strong><br>
      <em># AI Disease Prediction</em>
    </td>
    <td align="center" valign="top" style="padding:5px;">
      <img src="image5.png" width="80" style="border-radius:50%; height:auto;"><br><br>
      <strong>하연우 (Woo)</strong><br>
      <em># Depression Prediction</em>
    </td>
    <td align="center" valign="top" style="padding:5px;">
      <img src="image4.png" width="80" style="border-radius:50%; height:auto;"><br><br>
