...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>        
          <li> AI 질병 예측과 그래프로 보는 건강 분석 </li>  
          <li> 질병 별 위치기반 병원 매칭 서비스 </li>
          <li> 체형 분석을 통한 건강 맞춤 운동 솔루션 제공 </li>
          <li> 검진 데이터 기반 우울증 예측 및 맞춤 정보 제공 </li>
          <li> AI 분석을 통한 정확한 운동 자세 교정 서비스 </li>
        </ul>
      </td>
    </tr>
  </tbody>
