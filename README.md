...
<table style="width: 100%; border-collapse: collapse; table-layout: fixed;">
  <thead>
    <tr>
      <th style="min-width: 150px; padding: 16px; text-align: center; background-color: #222; color: white;">항목</th>
      <th style="min-width: 600px; padding: 16px; text-align: center; background-color: #222; color: white;">내용</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="vertical-align: middle; padding: 20px; line-height: 1.8;">개발 기간 🗓️</td>
      <td style="vertical-align: middle; padding: 20px; line-height: 1.8;">
        2025년 2월 24일(월) ~ 2025년 4월 1일(화)
      </td>
    </tr>
    <tr>
      <td style="vertical-align: middle; padding: 20px; line-height: 1.8;">프로젝트 목표</td>
      <td style="vertical-align: middle; padding: 20px; line-height: 1.8;">
